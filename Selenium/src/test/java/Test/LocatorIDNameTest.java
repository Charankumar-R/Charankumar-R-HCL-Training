...
public class LocatorIDNameTest {
	...
	public void mainTest() {
		...
		Assert.assertEquals(actResult, "Product");
	...
	public void mainTest1() {
		...
		WebElement selection = wait.until(ExpectedConditions.elementToBeClickable(By.id("item_4_img_link")));
		selection.click();

		WebElement logout = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"add-to-cart\"]")));
		logout.click();
