...
//			final String to = "bharathsbalaji05@gmail.com," + "kailashkarthikeyanms@gmail.com,"
//					+ "senthil.natarajan1979@gmail.com";
			...
			attachment1.attachFile(new File("reports/ExtentReport.html"));
			
			MimeBodyPart attachment2 = new MimeBodyPart();
			attachment2.attachFile(new File("reports/ExtentReport.html"));
